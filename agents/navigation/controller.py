...
class VehiclePIDController():
    ...
    def run_step(self, target_speed, waypoint, target_road_option):
        """
        ...
        if target_road_option.value == 1 or target_road_option.value == 2:
            steering_plus = 0.1
        else:
            steering_plus = 0.1

        if current_steering > self.past_steering + 0.1:
            current_steering = self.past_steering + steering_plus
